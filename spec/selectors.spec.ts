...
describe('NgrxJsonApiSelectors', () => {
  ...
  describe('selectStoreResourcesOfType', () => {
    it('should get all resources of a given type', fakeAsync(() => {
      let res;
      let sub = store.pipe(selectStoreResourcesOfType('Article')).subscribe(d => (res = d));
      tick();
    ...
    describe('selectManyQueryResult', () => {
      it('should get the StoreResource(s) that are the data of a query', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectManyQueryResult('1')).subscribe(d => (res = d));
        tick();
      ...
      it('should get undefined for non-existing query', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectManyQueryResult('doesNotExist')).subscribe(d => (res = d));
        tick();
      ...
      it('should get return an empty array if there are no data', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectManyQueryResult('55')).subscribe(d => (res = d));
        tick();
      ...
      it('should return undefined if the resources are not defined', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectManyQueryResult('56')).subscribe(d => (res = d));
        tick();
    ...
    describe('selectOneQueryResult', () => {
      it('should get the StoreResource that are the data of a query', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectOneQueryResult('2')).subscribe(d => (res = d));
        tick();
      ...
      it('should get undefined for non-existing query', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectOneQueryResult('doesNotExist')).subscribe(d => (res = d));
        tick();
        expect(res).toBeUndefined();
      }));
      ...
      it('should throw error if not a unique result is returned', fakeAsync(() => {
        let res;
        let err;
        let sub = store.pipe(selectOneQueryResult('1')).subscribe(d => (res = d), e => (err = e));
        tick();
        expect(res).toBeUndefined();
      ...
      it('should return null for no query result', fakeAsync(() => {
        let res;
        let sub = store.pipe(selectOneQueryResult('55')).subscribe(d => (res = d));
        tick();
    ...
    describe('selectStoreResources', () => {
      it('should get resources given types and ids', fakeAsync(() => {
        let res;
        let sub = store
          .pipe(selectStoreResources([{ type: 'Article', id: '1' }, { type: 'Article', id: '2' }]))
          .subscribe(d => (res = d));
        tick();
